                                                ...
                                                svy0(istokes,i)=vy(i)
                                                        ...
                                                        y(i)=sy0(istokes,i)+delta*svy0(istokes,i)/2.0d0 
                                                                if(tau==0.0d0)then
                                                                        ...
                                                                        vx(i)=svx0(istokes,i)-delta*(svx0(istokes,i))/(2.0d0*tau)+delta*fx(i)/2.0d0
                                                                        vy(i)=svy0(istokes,i)-delta*(svy0(istokes,i))/(2.0d0*tau)+delta*fy(i)/2.0d0
                                                                end if
                                        end do
                        y=modulo(y,l)
                        sxpart(istokes,:)=x
                                        ...
                                        do i=1,sizex 
                                                ...
                                                y(i)=sy0(istokes,i)+delta*vy(i)
                                                        ...
                                                        if(tau==0.0d0)then
                                                                ...
                                                                vx(i)=svx0(istokes,i)-delta*(vx(i))/tau+delta*fx(i)
                                                                vy(i)=svy0(istokes,i)-delta*(vy(i))/tau+delta*fy(i)
                                                        end if
                                        end do
