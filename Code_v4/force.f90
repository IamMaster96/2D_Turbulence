...
double precision :: wi,wj,ri,rj,dx,dy,r,f,l,fac2
fac2=2.0d0**(1.0d0/6.0d0)
l=8.0d0*atan(1.0d0)
                                       ...
                                       jybin=iy+jy
                                        ...
                                        if(jxbin.eq.-1)then
                                                ...
                                                do j=1,bin(0,jxbin,jybin)
                                                        ...
                                                        r=dsqrt(dx**2+dy**2)
                                                                if(r.le.fac2*meand)then
                                                                                                
                                                                        f=-4.0d0*((6.0d0*meand**6.0d0/r**7.0d0)-(12.0d0*meand**12.0d0/r**13.0d0))
                                                                        ftemp(1)=f*dx/r
                                                                        ftemp(2)=f*dy/r
