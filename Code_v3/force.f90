...
integer :: ix,iy,jx,jy,jxbin,jybin,i,j,iindex,jindex
double precision :: wi,wj,ri,rj,dx,dy,r,f,l,meandi,meandj,meandf
                                        ...
                                        if(jxbin.eq.-1)then
                                                ...
                                                do j=1,bin(0,jxbin,jybin)
                                                        ...
                                                        r=dsqrt(dx**2+dy**2)
                                                                ...
                                                                if(part_trac(iindex).le.(nparticle/2))then
                                                                meandi=meand
                                                                else
                                                                meandi=meand*1.4d0
                                                                end if

                                                                if(part_trac(jindex).le.(nparticle/2))then
                                                                meandj=meand
                                                                else
                                                                meandj=meand*1.4d0
                                                                end if

                                                                meandf=(meandi+meandj)/2.0d0

                                                                if(r.lt.meand)then
                                                                        f=1.0d0*(1.0d0-r/meandf)/meandf
                                                                        ftemp(1)=f*dx/r
                                                                        ftemp(2)=f*dy/r
