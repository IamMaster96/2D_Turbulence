...
call mpi_recv(part_trac(sizex+1),recv_u,mpi_integer,rank_u,14,mpi_comm_world,istatus1,ierr)
call mpi_recv(part_trac(sizex+recv_u+1),recv_l,mpi_integer,rank_l,8,mpi_comm_world,istatus2,ierr)
...
call mpi_wait(irequtrac,istatus2,ierr)
call mpi_wait(ireqltrac,istatus1,ierr)
